...
<center><div class="div1"><b>Your 'Read' list</b><br> </div></center><div class="wrapper">
...
String sql ="select bookId,username,bookName from readd where username = '"+username+"' ";
...
<td> <button><a href= "./rev_try.jsp?bookId=<%=resultSet.getString("bookId")%>&bookName=<%=resultSet.getString("bookName") %>">Write a review....</a></button></td>
